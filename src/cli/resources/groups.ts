...
registerResource({
  ...
  table: 'agent_groups',
  description:
    'Agent group — a logical agent identity. Each group has its own workspace folder (CODEX.md, skills, container config), conversation history, and container image. Multiple messaging groups can be wired to one agent group.',
  idColumn: 'id',
  scopeField: 'id',
  columns: [
    ...
    },
    {
      ...
      type: 'string',
      description:
        'Directory name under groups/ on the host. Must be unique. Contains CODEX.md, skills/, and container.json. Cannot be changed after creation.',
      required: true,
    },
